...
##to run: python PA_interventions_all_changes_and_structure.py
...
sel_intervention_node=14#np.random.permutation(np.arange(1, no_factors))[0]
...
ax[plot_row, 1].set_xlim([min_intervention_effect-1, max_intervention_effect+1])
