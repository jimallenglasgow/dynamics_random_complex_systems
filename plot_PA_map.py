...
kick_type=4 ##1=value, 2=max, 3=interaction, 4=random
...
G = nx.DiGraph(interactions_include)
...
all_edge_colors = np.reshape(interactions_include, (len(interactions_include[:,0])*len(interactions_include[:,0]), 1))
